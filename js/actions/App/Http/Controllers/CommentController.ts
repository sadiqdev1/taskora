...
/**
* @see \App\Http\Controllers\CommentController::toggleLike
 ...
 * @route '/comments/{comment}/like'
 */
    const toggleLikeForm = (args: { comment: number | { id: number } } | [comment: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/comments/{comment}/like'
 */
        toggleLikeForm.post = (args: { comment: number | { id: number } } | [comment: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: toggleLike.url(args, options),
            method: 'post',
        })
...
const CommentController = { index, store, toggleLike, destroy }
