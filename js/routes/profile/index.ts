...
/**
* @see \App\Http\Controllers\ProfileController::cover
 * @see app/Http/Controllers/ProfileController.php:169
 * @route '/profile/cover'
 */
export const cover = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: cover.url(options),
    method: 'post',
})
 ...
 * @route '/profile/cover'
 */
cover.url = (options?: RouteQueryOptions) => {
    return cover.definition.url + queryParams(options)
}
 ...
 * @route '/profile/cover'
 */
cover.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: cover.url(options),
    method: 'post',
})
 ...
 * @route '/profile/cover'
 */
    const coverForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: cover.url(options),
        method: 'post',
    })
 ...
 * @route '/profile/cover'
 */
        coverForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: cover.url(options),
            method: 'post',
        })
