    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen flex flex-col items-center justify-center px-4 text-center" style={{ background: 'var(--bg)' }}>
          <div className="w-16 h-16 rounded-2xl bg-[#FFE0E0] flex items-center justify-center text-3xl mb-4">⚠️</div>
          <h1 className="font-black text-2xl mb-2" style={{ color: 'var(--text)' }}>Something went wrong</h1>
